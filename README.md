...
The website is a commerce platform for watches, you can add products to your cart and wishlist and pay for them. If you want to try the checkout process, you can use the dummy card number/ upi/ Internet Bankinng provided by Razorpay for testing . 
...
![This is an image](/public/img/project-1.png)
## Run
...
The application displays different category of watches such as men's,women's,unisex.
